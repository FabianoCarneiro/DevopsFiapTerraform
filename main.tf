...
resource "aws_instance" "web" {
  ...
  user_data = <<-EOF
              ...
              echo "<style> body {background-color: blue;}</style><img src="https://www.impacta.edu.br/themes/wc_agenciar3/images/banners/graduacao/2024/banner-desktop-vestibular-2024-1.png">" > /var/www/html/index.html
